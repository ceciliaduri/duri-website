...
const HeroSection: React.FC = () => {
    return (
        <div className="relative w-full min-h-screen h-[100svh] overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-start justify-center text-white text-left pt-2 px-6 md:px-16 lg:pl-40 lg:px-4 w-full lg:w-2/3 h-full">
                ...
                <h1 className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6 md:mb-8">
                    Como Empresas Brasileiras
                    <span className="block text-red-300 mt-2 md:mt-3">
                        Queimam R$ 500k+ Por Ano
                    </span>
                    <span className="block text-white text-2xl md:text-4xl lg:text-5xl mt-3 md:mt-4">
                        em Custos Desnecessários de Importação
                    </span>
                </h1>
                
                {/* Subheadline - MELHOR CONTRASTE */}
                <h2 className="text-sm sm:text-base md:text-2xl text-white/90 leading-relaxed mb-6 md:mb-10 max-w-4xl backdrop-blur-sm bg-black/20 p-3 md:p-4 rounded-lg">
                ...
                <div className="flex flex-col items-start gap-6">
                    <button className="group bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600 text-white px-6 md:px-10 py-4 md:py-5 rounded-full font-bold text-base md:text-xl shadow-2xl transform hover:scale-105 transition-all duration-300 border-2 border-orange-400/50 hover:border-white/30">
                        Descobrir Quanto Estou Desperdiçando
                    </button>
                    
                    {/* Qualificação - MELHOR VISIBILIDADE */}
                    <p className="text-white/80 text-sm sm:text-lg font-medium bg-black/30 px-4 py-2 rounded-full">
                ...
                <div className="mt-6 md:mt-8 flex flex-wrap items-center gap-3 md:gap-6 text-xs md:text-sm text-white/70">
