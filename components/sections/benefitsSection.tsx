    ...
    return (
        <section className='flex flex-col py-12 md:py-16 px-6 md:px-16 lg:px-40 gap-10 md:gap-16'>
            ...
            <div className='flex flex-col md:flex-row justify-between gap-6 md:gap-16'>
                <Card className='flex flex-col items-center gap-6 p-6 shadow-md text-left md:text-justify'>
            ...
            <div className='flex flex-col items-center gap-8'>
                ...
                <Link href={'/contato'}>
                    <button className="bg-duri-light rounded-full py-2.5 px-8 font-bold text-white hover:bg-duri-dark">
                        Fale Conosco
                    </button>
                </Link>
            </div>
