    ...
    return (
        <section className='flex flex-col py-16 px-40 gap-16'>
            ...
            <div className='flex justify-between gap-16'>
                <Card className='flex flex-col items-center gap-6 p-6 shadow-md text-justify'>
